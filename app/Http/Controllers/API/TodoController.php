...
class TodoController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            // Tangkap hanya ValidationException untuk bisa akses ->errors()
            return response()->json([
                'status_code' => 422,
                'message' => 'Validasi Gagal.',
                'errors' => $e->errors(),
    ...
    //mencari todo berdasarkan judul atau category
    #[
        Response(
            status: 200,
            content: [
