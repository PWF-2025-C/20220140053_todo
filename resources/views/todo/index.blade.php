        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">Category</th> {{-- New Category Column --}}
            ...
            <tbody>
                @forelse ($todos as $data)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4"> {{-- New Cell for Category --}}
                            {{ $data->category->name ?? 'No Category' }} {{-- Adjust based on your category relationship --}}
                        </td>
